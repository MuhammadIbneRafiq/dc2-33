...
def define_london_stadiums():
    """
    Define London football stadiums with coordinates and risk classifications.
    ...
    return {
        ...
        'Tottenham': {
            ...
            'lat': 51.6040, 'lon': -0.0670,  # Corrected coordinates
            'borough': 'Haringey',
        ...
        'Crystal Palace': {
            ...
            'evidence': 'Lower crime volume, general stadium precaution'
        },
        'Fulham': {
...
def calculate_stadium_risk_factor(ward_centroid_lat, ward_centroid_lon, stadiums):
    """
    ...
    Args:
        ward_centroid_lat, ward_centroid_lon: Ward center coordinates
    ...
    for team, stadium in stadiums.items():
        distance = haversine_distance(
            ward_centroid_lat, ward_centroid_lon,
