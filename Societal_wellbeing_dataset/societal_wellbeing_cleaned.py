...
try:
    ...
    for encoding in encodings:
        try:
            ...
            lsoa_data = pd.read_csv("societal_wellbeing_dataset/lsoa-data-old-boundaries-DataSheet.csv", encoding=encoding)
    ...
    london_lsoa_codes = pd.read_csv("societal_wellbeing_dataset/LSOA_codes.csv")
    ...
    lsoa_data.to_csv("societal_wellbeing_dataset/lsoa-data-old-boundaries-london-cleaned.csv", index=False)
    print("Cleaned dataset saved as 'societal_wellbeing_dataset/lsoa-data-london-cleaned.csv'")
