  ...
  return (
    <div className="main-container min-h-screen">
      ...
      <main className="container mx-auto px-4 py-6">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-white mb-2">London Burglary Analysis Dashboard</h2>
          <p className="text-gray-400">
            Interactive visualization of burglary data across London, with police resource allocation optimization.
          </p>
        </div>
      ...
      <footer className="bg-gray-900 border-t border-gray-800 mt-6 py-4">
